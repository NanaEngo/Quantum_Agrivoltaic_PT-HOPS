...
# FMO target site index (Site 3, 0-indexed) — exit to reaction center
# The lowest-energy site in FMO (12210 cm⁻¹) funnels excitons to the RC.
# Transfer yield is defined as the long-time population of this site (Rev 3 Pt 1).
FMO_TARGET_SITE: Final[int] = 2
