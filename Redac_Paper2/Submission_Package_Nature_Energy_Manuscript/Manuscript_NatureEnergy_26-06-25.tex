...
On the macroscopic scale, this ``smart shield'' reduces crop evapotranspiration by \qty{28}{\percent} (FAO-56 Penman--Monteith parameterization) and yields a Net Ecological Benefit of 19.6~kg~CO$_2$e/m$^2$/yr, with a \qty{1700}{\percent} improvement in crop biomass over static shading.
...
\textbf{Heavy metal contamination} of irrigation water (Pb$^{2+}$) is quantified through Stern--Volmer fluorescence quenching of co-deployed CdTe/ZnSe carbon quantum dots (LOD = \qty{31.8}{\nano\mol\per\L})~\cite{Mohammed2023}, which are immune to the dust-biofouling fouling that affects bare gold surfaces.
...
The bath spectral density follows the 12-mode Kleinekath\"{o}fer/Coker parameterization with a Drude--Lorentz background ($\lambda_D = \qty{35}{\per\cm}$, $\gamma_D = \qty{50}{\per\cm}$) and 12 underdamped vibronic modes (frequencies \SIrange{180}{1500}{\per\cm}, Huang--Rhys factors $S_k = \numrange{0.003}{0.050}$).
