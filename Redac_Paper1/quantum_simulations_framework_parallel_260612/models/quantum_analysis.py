...
class QuantumAnalysisSuite:
    ...
    @classmethod
    def calculate_bipartite_entanglement(
        cls, rho: NDArray[np.complex128], partition: Optional[List[int]] = None
    ) -> float:
    ...
    @staticmethod
    def calculate_quantum_synergy_index(
        rho_opv: NDArray[np.complex128], rho_psu: NDArray[np.complex128]
    ) -> float:
    ...
    @staticmethod
    def calculate_mandel_q_parameter(
        vibrational_mode_occupations: NDArray[np.float64],
    ) -> float:
    ...
    @staticmethod
    def stochastically_bundled_dissipators(
        rho: NDArray[np.complex128],
        l_bundled: List[NDArray[np.complex128]],
        p_alpha: List[float],
    ...
    def spectral_density_drude_lorentz(
        omega: Union[float, NDArray[np.float64]], lambda_reorg: float, gamma: float
