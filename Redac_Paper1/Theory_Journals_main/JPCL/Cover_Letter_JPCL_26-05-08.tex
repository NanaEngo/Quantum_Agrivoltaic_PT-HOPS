...
\begin{enumerate}
\item \textbf{Stabilized convergence audit.} We have executed a new convergence audit at hierarchy depth $L=8$ and $K=2$ Matsubara terms. This configuration is mathematically converged within \SI{0.0001}{\percent} (MAE $\approx 3.1 \times 10^{-11}$) and was selected to ensure maximum memory stability on 128 GB hardware environments, resolving previous numerical inconsistencies noted by Reviewers 1 and 3.
