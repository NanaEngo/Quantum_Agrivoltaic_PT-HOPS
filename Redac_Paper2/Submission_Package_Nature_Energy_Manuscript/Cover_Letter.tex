...
\item \textbf{Socioeconomic viability with carbon credits:} The Net Ecological Benefit of \qty{12.4}{\kg\ CO2e\per\m\squared\per\yr} qualifies the system for voluntary carbon markets. At \qty{10}{\USD\per\tonne\ CO2e}, the system generates \qty{62}{\USD\per\yr} in verified carbon revenue (\qty{0.2}{\percent} of the net annual cashflow), further improving the investment case without altering the \qty{4.23}{\yr} cooperative payback --- making quantum-enhanced agrivoltaics financially accessible in developing economies.
