...
Le codebase officiel est situé dans `/quantum_simulations_framework/`. Les commentaires du Reviewer 3 nécessitent plusieurs correctifs au niveau des scripts d'analyse et potentiellement de la dynamique.
...
2. [ ] Lancer la simulation de production (100 trajectoires) sur le serveur/cluster pour capturer la décohérence complète :
   ```bash
   cd /home/taamangtchu/Documents/Github/Quantum_Agrivoltaic_PT-HOPS/quantum_simulations_framework/
