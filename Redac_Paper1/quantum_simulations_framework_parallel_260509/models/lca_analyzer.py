...
class LCAAnalyzer:
    ...
    def __init__(
        self,
        system_lifetime: float = DEFAULT_SYSTEM_LIFETIME,
        annual_irradiance: float = SOLAR_IRRADIANCE_ANNUAL,
        ...
        self.lca_parameters = {
            # Manufacturing phase
            "manufacturing_carbon_intensity": LCA_CARBON_INTENSITY_MFG,
            "material_toxicity_factor": LCA_TOXICITY_FACTOR,
            "resource_depletion_factor": LCA_RESOURCE_DEPLETION_FACTOR,
            # Operational phase
            "maintenance_energy_factor": LCA_MAINTENANCE_FACTOR,
            "cleaning_energy_factor": LCA_CLEANING_FACTOR,
            # End-of-life phase
            "recycling_rate": LCA_RECYCLING_RATE,
            "landfill_impact": LCA_LANDFILL_IMPACT,
            "recycling_energy": LCA_RECYCLING_ENERGY_FACTOR,
            # Reference values
            "reference_silicon_carbon": SILICON_PV_CARBON,
            "reference_silicon_epbt": SILICON_PV_EPBT,
        }
    ...
    def calculate_manufacturing_impact(
        ...
        # Convert MJ to kWh for carbon calculation
        energy_kwh = manufacturing_energy * MJ_TO_KWH
    ...
    def calculate_operational_impact(
        ...
        baseline_energy = LCA_MANUFACTURING_ENERGY_BASE
        ...
        grid_carbon_intensity = LCA_CARBON_INTENSITY_GRID
        energy_kwh = total_energy * MJ_TO_KWH
    ...
    def calculate_end_of_life_impact(
        ...
        carbon_credit = recycled_mass * LCA_CARBON_CREDIT_RECYCLE

        # Landfill impact
        landfill_impact = landfill_mass * self.lca_parameters["landfill_impact"]

        # Net carbon (recycling energy - carbon credit)
        recycling_carbon = recycling_energy * MJ_TO_KWH * LCA_CARBON_INTENSITY_GRID
    ...
    def calculate_lca_impact(
        self,
        manufacturing_energy: float = LCA_MANUFACTURING_ENERGY_BASE,
