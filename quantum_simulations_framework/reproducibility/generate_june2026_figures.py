...
Outputs (saved to Redac_Paper1/JPCL_Submission_Package_2026-06-20/Figures/):
...
# Core Constants
# ──────────────────────────────────────────────────────────────────────
from src.core.constants import DEFAULT_HUANG_RHYS_FACTORS, DEFAULT_VIBRONIC_FREQUENCIES

# Submission package output — dedicated Figures/ subfolder
# Configurable via env var QSF_OUTPUT_DIR (for server deployment).
# Relative path: quantum_simulations_framework/../Redac_Paper1/JPCL.../Figures
...
# Physical constants
# ──────────────────────────────────────────────────────────────────────
FMO_SITE_ENERGIES = np.array([12410, 12530, 12210, 12320, 12480, 12630, 12440], dtype=float)  # cm⁻¹
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Regenerate publication figures from June 2026 data."
    )
    parser.add_argument(
