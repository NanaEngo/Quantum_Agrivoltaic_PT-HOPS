...
\subsection{Process Tensor HOPS and Stochastically Bundled Dissipators framework}

We quantified these effects using a scalable non-Markovian solver based on Process Tensor HOPS (PT-HOPS) combined with Stochastically Bundled Dissipators (SBD). This hybrid framework maintains the numerical fidelity of hierarchical equations of motion (HEOM) while reducing computational cost.
