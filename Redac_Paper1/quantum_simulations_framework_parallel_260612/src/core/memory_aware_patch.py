...
def apply_memory_aware_patching():
    ...
    def _simulate_with_mesohops_patched(
        ...
        **kwargs: Any,
        ...
        # Setting it here would kill joblib's loky backend (needs memory to spawn).
        ...
        dt_save = kwargs.get(
            "dt",
            float(time_points[1] - time_points[0]) if len(time_points) > 1 else 1.0,
        )
        ...
        worker_args = {
            ...
            "mem_limit_gb": sched_info["memory_per_traj_gb"],
        }
