...
class TestParameterConsistency:
    ...
    def test_reorganization_energy(self):
        assert self.cfg["bath"]["reorganization_energy"] == DEFAULT_REORGANIZATION_ENERGY
...
class TestHamiltonianFactory:
    ...
    def test_spectral_density_positive_omega(self):
        ...
        J = spectral_density_drude_lorentz(omega, DEFAULT_REORGANIZATION_ENERGY, DEFAULT_DRUDE_CUTOFF, DEFAULT_TEMPERATURE)
    ...
    def test_spectral_density_zero_at_zero(self):
        ...
        J = spectral_density_drude_lorentz(np.array([0.0]), DEFAULT_REORGANIZATION_ENERGY, DEFAULT_DRUDE_CUTOFF, DEFAULT_TEMPERATURE)
        assert abs(J[0]) < 1e-6
