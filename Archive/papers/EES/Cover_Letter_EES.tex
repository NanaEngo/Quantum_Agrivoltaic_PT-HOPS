...
\begin{itemize}
    ...
    \item \textbf{Computational materials science.} We employ non-Markovian quantum dynamics methods (Process Tensor HOPS and Stochastically Bundled Dissipators) that offer significant computational advantages while maintaining accuracy, enabling modeling of complex energy conversion processes relevant to photosynthesis and solar energy.
