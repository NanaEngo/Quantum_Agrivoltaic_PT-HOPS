...
print(
    "   - Saves all matplotlib figures to the specified folder (defaults to figures/)"
)

print("\nExample usage in the notebook:")
print("   # After running quantum dynamics simulation")
print(
    "   save_simulation_data_to_csv(time_points, populations, coherences, qfi_values, etr_values, 'my_simulation')"
)
print(
    "   # This will create figures/my_simulation_dynamics.csv and figures/my_simulation_summary.csv"
)
