...
We submit the revised version of our manuscript ``Quantum-Coherent Spectral Engineering: Non-Markovian Dynamics in Photosynthetic Energy Transfer under Engineered Photon Baths'' (Manuscript ID: jz-2026-XXXX) for consideration as a Letter in The Journal of Physical Chemistry Letters.
...
\item \textbf{TOC Graphic included:} A TOC Graphic is included via the \texttt{tocentry} environment in the \texttt{achemso} class, immediately preceding the document body, as required.
\item \textbf{Supporting Information:} The SI file has been checked and contains no highlighting, tracked changes, or colored text.
\end{enumerate}
