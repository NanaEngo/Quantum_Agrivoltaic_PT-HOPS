...
**Note on Title Change:** In response to the reviewers' comments regarding the terminology "spectral bath engineering", we have updated the manuscript title to **"Selective Vibronic Excitation for Coherent Energy Transport in Photosynthetic and Agrivoltaic Systems"**. This title more precisely identifies the physical mechanism of selective vibronic excitation and explicitly states the relevance to agrivoltaic systems.
