...
Secure IoT telemetry over a buried single-mode fibre BB84 QKD link ensures field-to-cloud data integrity at QBER = \qty{4.8}{\percent}, with an automatic irrigation fail-safe triggered when QBER exceeds the Shor--Preskill threshold of \qty{11}{\percent}.
...
With a nominal fibre noise rate of \qty{4.8}{\percent}, the protocol achieves QBER $= 4.8\%$ and generates a \qty{256}{\bit} symmetric key per session --- sufficient for AES-256 encrypted telemetry.
