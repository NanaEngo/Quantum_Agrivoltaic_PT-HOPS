...
def fix_notebook_json():
    ...
    if extracted_json:
        ...
        try:
            ...
            with open(
                "/media/taamangtchu/MYDATA/Github/Comparative-study-of-the-Anderson-model-in-weak-and-strong-interaction-regimes/Redac_Paper1/extracted_json.json",
                "w",
            ) as f:
                f.write(extracted_json)

            print(
                "Extracted content saved to extracted_json.json for manual inspection"
            )
            return False
    else:
