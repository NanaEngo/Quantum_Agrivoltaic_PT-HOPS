...
\item \textbf{Proof-of-concept at farm scale:} A \SI{500}{\m\squared} cooperative high-tunnel greenhouse in Cameroon's Western Highlands saves \SI{650}{\m\cubed\per\yr} of irrigation water, generates an additional \SI{1.23}{\kg\per\m\squared\per\yr} of high-value floriculture, produces \SI{90}{\MWh\per\yr} of OPV electricity, and achieves cooperative CAPEX payback in \SI{4.23}{\yr} (\SI{30}{\percent} blended-finance subsidy) with a 10-year NPV of \SI{+37664}{\USD}.

\item \textbf{Socioeconomic viability with carbon credits:} The Net Ecological Benefit of \SI{12.4}{\kg\ CO2e\per\m\squared\per\yr} qualifies the system for voluntary carbon markets. At \SI{10}{\USD\per\tonne\ CO2e}, the system generates \SI{62}{\USD\per\yr} in verified carbon revenue (\SI{0.2}{\percent} of the net annual cashflow), further improving the investment case without altering the \SI{4.23}{\yr} cooperative payback --- making quantum-enhanced agrivoltaics financially accessible in developing economies.
