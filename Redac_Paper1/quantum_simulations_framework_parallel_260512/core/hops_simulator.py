...
class HopsSimulator:
    ...
    **kwargs : Any
    ...
    def _get_memory_estimate(self, n_hierarchy_modes: int = 189) -> float:
        """Estimate memory per trajectory with modes_factor scaling."""
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if MemoryAwareJobScheduler is not None:
                ...
                n_hierarchy_modes = len(self.system_param.get("GW_SYSBATH", [])) if self.system_param else 189
                ...
                batch_size = n_traj
                n_batches = 1
                logger.warning("MemoryAwareJobScheduler not available, running sequentially (n_jobs=1)")
