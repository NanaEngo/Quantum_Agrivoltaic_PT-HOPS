...
class BiodegradabilityAnalyzer:
    ...
    def calculate_biodegradability_score(self, weights: Optional[Dict[str, float]] = None) -> float:
        ...
        if weights is None:
            ...
            weights = {
                "fukui_nucleophilic": BIO_WEIGHT_NUC,
                "fukui_electrophilic": BIO_WEIGHT_ELEC,
                "dual_descriptor": BIO_WEIGHT_DUAL,
                "global_softness": BIO_WEIGHT_SOFTNESS,
                "max_fukui": BIO_WEIGHT_MAX_FUKUI,
            }
